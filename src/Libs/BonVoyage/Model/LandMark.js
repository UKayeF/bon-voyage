...
class LandMark {
  static defaultList = [
    ...
    },
    {
      distance: 180000,
      visited: false,
      mapData: {'id': 'beta-centauri', 'symbol': 'B', className: 'text-info'},
      action: function (store) {
        return {state: GameState.states.planet, data: Planet.planets['beta-centauri']};
      }
    },
    {
      distance: 210000,
      visited: false,
      mapData: {'id': 'andromeda', 'symbol': 'A', className: 'text-info'},
      action: function (store) {
        return {state: GameState.states.planet, data: Planet.planets['andromeda']};
      }
    },
    {
      distance: 5000,
