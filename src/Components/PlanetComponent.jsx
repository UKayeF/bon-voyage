      ...
      <div className={this.props.visibility ? '' : 'hidden'}>
        ...
        <div className="tbl-resources fullwidth">
          ...
          <div>
            <div>Capacity</div>
            <div><span
              className="text-info">{this.props.store.playerFleet.usedCapacity}/{this.props.store.playerFleet.capacity}</span>
            </div>
          </div>
        </div>
        <div>
