...
//var async = require("async");
      ...
      var battle = function (attackerList, defenderList, numSimulations, afterFunction) {
        ...
        console.log('ogsim init', attackerList, defenderList);
    ...
    }, {'./attackstatistics': 4, './config': 6, './group': 9, './roundstatistics': 11, './timer': 12, './tools': 13}],
...
//Ogame data!!
      exports.pricelist = {
        ...
        '217': {
          'id': '217',
          'code': 'evolution_transporter',
          'name': 'Evolution Transporter',
          'metal': 35000,
          'crystal': 20000,
          'deuterium': 1500,
          'energy': 0,
      ...
      exports.rapidfire = {
        ...
        '218': {
          '202': 12500, '203': 12500, '204': 10000, '205': 5000,
          '206': 1650, '207': 1500, '208': 12500, '209': 12500, '210': 62500,
          '211': 1250, '213': 250, '214': 12, '215': 750, '216': 12, '217': 2500, '220': 250,
          '401': 10000, '402': 10000, '403': 5000, '404': 2500, '405': 5000, '406': 5
        },
        '220': {
          '202': 100, '203': 50, '204': 100, '205': 50, '206': 25, '207': 20,
          '208': 50, '209': 50, '210': 50, '215': 20, '217': 20, '401': 80, '402': 100,
          '403': 10,
        },
      };
...
//Optionally, a player can add more fleets to a mission
        var fleet = function (fleetUnits, pricelist, rapidfireConfig, military_tech, defense_tech, hull_tech, player_id) {
          ...
          for (var id in fleetUnits) {
            if (!fleetUnits.hasOwnProperty(id)) {
              continue;
            } //!!
...
//Push the fleet data configuration to the global array of ships
        fleet.prototype.expandTo = function (dataArray) {
          ...
          for (var id in this.unitTypes) {
            if (!this.unitTypes.hasOwnProperty(id)) {
              continue;
            }
...
//status of the current fleet, after a round of shots
      ...
      }, {'./fleetunittype': 8, './resource': 10, './tools': 13}],
...
//Ships' rapidfire against other unit types
        resource.prototype.initializeRapidfire = function (rapidfireConf) {
          ...
          if (rapidfireConf[this.id]) {
            ...
            for (var n in rapidFireRules) {
              if (!rapidFireRules.hasOwnProperty(n)) {
                continue;
              }
              r = rapidFireRules[n];
        ...
        resource.getShipTypes = function () {
          return ['202', '203', '204', '205', '206', '207', '208', '209', '210', '211', '212', '213', '214', '215', '216', '217', '218', '220'];
        };
...
//var prettyHrtime = require('pretty-hrtime'); //leave this line alone
          ...
          timer.prototype.buildResults = function () {
            ...
            for (var id in this.records) {
              ...
              this.records[id].description = process.hrtime(this.records[id].end, {precise: true});
      ...
      }, {'_process': 1, 'browser-process-hrtime': 2}],
